...
public:
	...
	std::vector<long> optimizationTimes;
    long totalOptimizationTime = 0;
    long maxOptimizationTime = 0;
    long minOptimizationTime = LONG_MAX;
    long avgOptimizationTime = 0;

	//parameters
	double t_var;
	double q_var;
	double var;
	double vio_loss_para;
	double gps_loss_para;
	int windows_size;
	int max_iterations;
