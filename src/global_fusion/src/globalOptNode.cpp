...
int main(int argc, char **argv)
{
    ...
    globalEstimator.loadParameters(n);

    ros::Subscriber sub_GPS = n.subscribe("/gps_data", 100, GPS_callback);
    ros::Subscriber sub_vio = n.subscribe("/vio_odom", 100, vio_callback);
